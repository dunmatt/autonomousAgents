...
public class TestAgent extends Agent_F {
    ...
    public TestAgent(String thisID, double iX, double iY, long seed, Hashtable SchdulerObjectManagementList) {
        super("testagent" + thisID, iX, iY, seed, SchdulerObjectManagementList);
    }
